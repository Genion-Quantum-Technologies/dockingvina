...
# 服务管理
./start_dockingvina_service.sh start
```
...
# 服务配置
MAMBA_ENV_NAME="dockingvina"
SERVICE_PORT=8002

# 日志配置
LOG_DIR="/home/davis/projects/serverlogs"
LOG_FILE="$LOG_DIR/dockingvina.log"
```

### Micromamba环境

脚本会自动检查和创建micromamba环境：
- 环境名称：`dockingvina`
- 配置文件：`env.yml`
- 自动安装依赖包
...
- **端口**: 8002（本地服务，无需反向代理）
- **日志路径**: `/home/davis/projects/serverlogs/dockingvina.log`
- **PID文件**: `/home/davis/projects/serverlogs/dockingvina.pid`
...
- **API根路径**: http://localhost:8002/
- **健康检查**: http://localhost:8002/health
- **API文档**: http://localhost:8002/docs
- **状态查询**: http://localhost:8002/status
...
- **服务日志**: `/home/davis/projects/serverlogs/dockingvina.log`
- **错误排查**: 查看日志文件中的错误信息
...
| 特性 | AstraMolecula | Peptide Optimization | Docking Vina |
|------|---------------|---------------------|--------------|
| 反向代理 | ✅ 有AutoSSH隧道 | ❌ 本地服务 | ❌ 本地服务 |
| 端口 | 8000 | 8001 | 8002 |
| 部署方式 | 云服务器+本地 | 仅本地 | 仅本地 |
| 日志路径 | 统一serverlogs | 统一serverlogs | 统一serverlogs |
| 脚本结构 | 相同 | 相同 | 相同 |

## 🔄 更新记录

- 初始版本：基于peptide_opt架构创建
- 简化部署：去除反向代理配置
- 本地服务：专注本地API服务
- 端口配置：使用8002端口避免冲突
